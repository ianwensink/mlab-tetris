 ...
 */
class ViewerItemCardType {
    constructor(id, name, imageHeight, imageWidth, titleMaxWords, summaryMaxWords, titleFontSize, summaryFontSize, titleMinHeight, dateMinHeight, summaryMinHeight) {
        this.id = id;
        this.name = name;
